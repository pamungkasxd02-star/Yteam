...
const (
	...
	EventRunStarted       = "session.run.started"
	EventRunRetrying      = "session.run.retrying"
	EventRunCompleted     = "session.run.completed"
	EventRunFailed        = "session.run.failed"
	EventRunInterrupted   = "session.run.interrupted"
