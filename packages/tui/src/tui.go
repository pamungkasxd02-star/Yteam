...
func (ui *UI) draw() {
	...
	if ui.route == RouteHome {
		...
		fmt.Fprintln(ui.out, "")
		fmt.Fprintln(ui.out, "  "+Style("Placeholders & Examples:", Bold, FgBrightYellow))
		fmt.Fprintln(ui.out, "    "+Style("•", FgYellow)+" "+Style("What is the tech stack of this project?", Italic, FgGray))
